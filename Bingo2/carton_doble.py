...
Principios SOLID aplicados:
  LSP — CartonDoble puede sustituir a ICarton/Carton en cualquier contexto
        sin romper el comportamiento esperado. Llama super() correctamente
        en todos los métodos sobrescritos.
  OCP — tipo_nombre() sobrescrito: agregar este tipo no requirió modificar
...
class CartonDoble(Carton):
    ...
    def tipo_nombre(self) -> str:
        """OCP: sobrescribe tipo_nombre() sin modificar ninguna clase existente."""
        return "CartónDoble"
